...
from order_history.database import get_session
...
class Queries:
    async def get_all_customers(self) -> list[CustomerType]:
    ...
    async def get_customer(self, customer_id: uuid.UUID) -> CustomerType | None:
        async with get_session() as session:
